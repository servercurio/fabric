...
public class MerkleMapException extends CollectionException {
     ...
     *                method.
     */
    public MerkleMapException(final String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public MerkleMapException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public MerkleMapException(final Throwable cause) {
        super(cause);
    }
}
