...
public class ObjectNotSerializableException extends IOException {
      /**
       ...
       *                method.
       */
      public ObjectNotSerializableException(final String message) {
            super(message);
      }
       ...
       * @since 1.4
       */
      public ObjectNotSerializableException(final String message, final Throwable cause) {
            super(message, cause);
      }

      /**
       * Constructs a new runtime exception with the specified cause and a detail message of {@code (cause==null ? null
       * : cause.toString())} (which typically contains the class and detail message of {@code cause}).  This
       ...
       * @since 1.4
       */
      public ObjectNotSerializableException(final Throwable cause) {
            super(cause);
      }
}
